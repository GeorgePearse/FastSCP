...
def create_html_viewer(metadata_file="transformation_samples/metadata.json", output_file="transformation_viewer.html"):
    ...
    # Generate HTML with concatenation to avoid format string issues
    html_parts = []
...
<body>
    ...
    <div class="sample-group">
        ...
        if group["transforms"]:
            ...
            html_parts.append(f'            <strong>Blend Mode:</strong> {t["blend_mode"]}<br>')
            html_parts.append(f'            <strong>Scale Range:</strong> {t["scale_range"]}<br>')
        
        html_parts.append('''        </div>
        <div class="images">
            <div class="image-container">''')
        html_parts.append(f'                <img src="transformation_samples/{orig_file}" alt="Original">')
        ...
        for t in group["transforms"]:
            html_parts.append('''
            <div class="image-container">''')
            html_parts.append(f'                <img src="transformation_samples/{t["transformed"]}" alt="Transformed">')
